...
class AreaController extends ArnmController
{
  ...
  public function newAction($templateId)
  {
    ...
    return $this->render('ArnmPagesBundle:Area:new.html.twig', array(
        'entity' => $entity, 
        'template' => $template, 
  ...
  public function createAction($templateId)
  {
    ...
    if($form->isValid()) {
      ...
      return $this->redirect($this->generateUrl('Araneum_area_show', array(
  ...
  public function editAction($templateId, $id)
  {
    ...
    return $this->render('ArnmPagesBundle:Area:edit.html.twig', array(
        'entity' => $entity, 
        'template' => $template, 
  ...
  public function updateAction($templateId, $id)
  {
    ...
    if($editForm->isValid()) {
      ...
      return $this->redirect($this->generateUrl('Araneum_area_edit', array(
          'templateId' => $template->getId(), 
          'id' => $id
      )));
    }
